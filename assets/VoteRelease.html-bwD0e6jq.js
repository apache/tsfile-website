import{_ as e,o as i,c as n,a as s,b as a}from"./app-IhqvkLYY.js";const d={},l=a(`<h1 id="给发布版本投票" tabindex="-1"><a class="header-anchor" href="#给发布版本投票" aria-hidden="true">#</a> 给发布版本投票</h1><p>For non-Chinese users, please read https://cwiki.apache.org/confluence/display/IOTDB/Validating+a+staged+Release</p><h2 id="下载投票的-版本-rc-下的所有内容" tabindex="-1"><a class="header-anchor" href="#下载投票的-版本-rc-下的所有内容" aria-hidden="true">#</a> 下载投票的 版本/rc 下的所有内容</h2><p>https://dist.apache.org/repos/dist/dev/iotdb/</p><h2 id="导入发布经理的公钥" tabindex="-1"><a class="header-anchor" href="#导入发布经理的公钥" aria-hidden="true">#</a> 导入发布经理的公钥</h2><p>https://dist.apache.org/repos/dist/dev/iotdb/KEYS</p><p>最下边有 Release Manager (RM) 的公钥</p><p>安装 gpg2</p><h3 id="第一种方法" tabindex="-1"><a class="header-anchor" href="#第一种方法" aria-hidden="true">#</a> 第一种方法</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>公钥的开头是这种
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,35);function r(t,c){return i(),n("div",null,[s(`
...
`),l])}const u=e(d,[["render",r],["__file","VoteRelease.html.vue"]]);export{u as default};
