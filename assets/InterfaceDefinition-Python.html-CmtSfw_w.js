...
<span class="line"><span style="color:#98C379;">    &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">    Query table data and time-series data from TsFile, providing standardized file reading and query interfaces.</span></span>
<span class="line"><span style="color:#98C379;">    Supports full core capabilities including table model query, tree model query, metadata acquisition, and resource management.</span></span>
<span class="line"><span style="color:#98C379;">    &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Initialize the TsFile reader for the specified path, complete file loading and underlying reader initialization,</span></span>
<span class="line"><span style="color:#98C379;">        and maintain all active query result sets to ensure all result sets are invalidated synchronously when the reader is closed.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :param pathname: Full path of the TsFile to be read</span></span>
<span class="line"><span style="color:#98C379;">        :return: No return value</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Perform time-range query on the specified table and columns, supporting tag filtering and batch reading mode.</span></span>
<span class="line"><span style="color:#98C379;">        Adapts to both row-by-row return and fixed-size data block return modes to meet reading requirements in different scenarios.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :param table_name: Name of the target table to query, case-insensitive</span></span>
<span class="line"><span style="color:#98C379;">        :param column_names: List of target column names to retrieve; all columns are queried by default if empty</span></span>
<span class="line"><span style="color:#98C379;">        :param start_time: Start timestamp of the query range, default is the minimum value of int64 type</span></span>
<span class="line"><span style="color:#98C379;">        :param end_time: End timestamp of the query range, default is the maximum value of int64 type</span></span>
<span class="line"><span style="color:#98C379;">        :param tag_filter: Optional parameter, filter conditions based on tag columns, supporting equality, range, and logical combination filters</span></span>
<span class="line"><span style="color:#98C379;">        :param batch_size: Batch reading size; row-by-row mode is enabled when ≤ 0, data blocks are returned by the specified size when &gt; 0</span></span>
<span class="line"><span style="color:#98C379;">        :return: Encapsulated query result set handler for traversing data, reading data, and obtaining metadata</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Perform table query on the tree model structure, adapted for query scenarios of native tree-structured time-series data.</span></span>
<span class="line"><span style="color:#98C379;">        Query directly based on measurement names without specifying a table name; path names are case-sensitive.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :param column_names: List of measurement names to query, corresponding to node paths in the tree structure</span></span>
<span class="line"><span style="color:#98C379;">        :param start_time: Start timestamp of the query range, default is the minimum value of int64 type</span></span>
<span class="line"><span style="color:#98C379;">        :param end_time: End timestamp of the query range, default is the maximum value of int64 type</span></span>
<span class="line"><span style="color:#98C379;">        :return: Result set handler corresponding to the tree model query</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Query tree model time-series data by row with pagination, supporting offset skipping and maximum return row limit.</span></span>
<span class="line"><span style="color:#98C379;">        Adapted for large data volume pagination reading to avoid memory overflow caused by loading excessive data at once.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :param device_ids: List of device IDs to query, cannot be empty</span></span>
<span class="line"><span style="color:#98C379;">        :param measurement_names: List of measurement names to query, cannot be empty</span></span>
<span class="line"><span style="color:#98C379;">        :param offset: Number of starting rows to skip, starting from 0 by default</span></span>
<span class="line"><span style="color:#98C379;">        :param limit: Maximum number of rows to return; no limit if less than 0</span></span>
<span class="line"><span style="color:#98C379;">        :return: Result set handler for tree model pagination query</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#D19A66;font-style:italic;">                           batch_size</span><span style="color:#ABB2BF;">: </span><span style="color:#56B6C2;">int</span><span style="color:#56B6C2;"> =</span><span style="color:#D19A66;"> 0</span><span style="color:#ABB2BF;">) -&gt; </span><span style="color:#56B6C2;">object</span><span style="color:#ABB2BF;">:</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Query table model data by row with pagination, supporting offset and row limit pushdown, and can be used with tag filtering.</span></span>
<span class="line"><span style="color:#98C379;">        Invalid data can be skipped at the data block level for dense devices, greatly improving pagination query efficiency.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :param table_name: Name of the target table to query</span></span>
<span class="line"><span style="color:#98C379;">        :param column_names: List of column names to query</span></span>
<span class="line"><span style="color:#98C379;">        :param offset: Number of starting rows to skip, starting from 0 by default</span></span>
<span class="line"><span style="color:#98C379;">        :param limit: Maximum number of rows to return; no limit if less than 0</span></span>
<span class="line"><span style="color:#98C379;">        :param tag_filter: Optional parameter, tag filter condition to filter device data that meets the criteria</span></span>
<span class="line"><span style="color:#98C379;">        :param batch_size: Batch reading size, adapted to the underlying data block reading logic</span></span>
<span class="line"><span style="color:#98C379;">        :return: Result set handler for table model pagination query</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Perform time-range time-series data query for a single specified device.</span></span>
<span class="line"><span style="color:#98C379;">        Adapted for precise query scenarios of a single device with multiple sensors, simplifying query invocation logic.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :param device_name: Name/path of the target device</span></span>
<span class="line"><span style="color:#98C379;">        :param sensor_list: List of sensor (measurement) names to query</span></span>
<span class="line"><span style="color:#98C379;">        :param start_time: Query start timestamp; starts from the earliest time of the file by default if 0</span></span>
<span class="line"><span style="color:#98C379;">        :param end_time: Query end timestamp; ends at the latest time of the file by default if 0</span></span>
<span class="line"><span style="color:#98C379;">        :return: Result set handler for single-device time-series query</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Get the complete schema information of the specified table, including full metadata such as column names, data types, tag columns, and time-series constraints.</span></span>
<span class="line"><span style="color:#98C379;">        Used to verify the legality of query fields in advance and parse data structures.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :param table_name: Name of the target table</span></span>
<span class="line"><span style="color:#98C379;">        :return: Schema information object of the corresponding table, containing full configuration of the table structure</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Get schema information of all tables in the current TsFile.</span></span>
<span class="line"><span style="color:#98C379;">        Traverse all data table structures in the file with one click without querying table by table.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :return: Dictionary structure, key is table name, value is schema information object of the corresponding table</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Get schema information of all time-series in the TsFile.</span></span>
<span class="line"><span style="color:#98C379;">        Covers field, type, and constraint information of full time-series data in both tree model and table model.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :return: List of all time-series schema information</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Get identification information of all devices in the TsFile.</span></span>
<span class="line"><span style="color:#98C379;">        Can traverse all devices in the file, adapted for full-device statistics and batch query pre-operations.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :return: List composed of all device IDs/device paths</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Get time-series metadata of specified devices, including data storage segments, field constraints, data ranges, etc.</span></span>
<span class="line"><span style="color:#98C379;">        Returns metadata of all devices by default if no device ID is passed, returns an empty dictionary if an empty list is passed.</span></span>
<span class="line"></span>
<span class="line"><span style="color:#98C379;">        :param device_ids: Optional parameter, list of device IDs to query metadata for</span></span>
<span class="line"><span style="color:#98C379;">        :return: Dictionary structure, key is device path, value is time-series metadata group of the corresponding device</span></span>
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#98C379;">        &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#98C379;">        Close the TsFile reader, release underlying file handles and memory resources.</span></span>
<span class="line"><span style="color:#98C379;">        Mark all current active query result sets as invalid and prohibit subsequent data reading operations.</span></span>
<span class="line"><span style="color:#98C379;">        No query or metadata acquisition operations can be performed after closing; the reader needs to be reinitialized.</span></span>
